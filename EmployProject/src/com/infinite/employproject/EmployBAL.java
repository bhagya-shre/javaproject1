...
public boolean isValid(Employ employ){
	...
	if(employ.getEmpno()<=0){
		valid=false;
		sb.append("Employ no can't be negative or zero..\r\n");
	}
	...
	if(employ.getDept().length()<4){
		valid=false;
		sb.append("Employ Name contains min. 3 chars..\r\n");
	}
	...
	if(employ.getBasic()<5000)
	{
		valid=false;
		sb.append("Employ Employ basic must be between 5000 to 80000...\r\n");
		return valid;
	}
	return valid;
